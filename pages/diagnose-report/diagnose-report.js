...
Page({
  data: {
    ...
    scoreGap: 22,
    corePoints: [
      { id: 7, name: '作文逻辑不清晰', priority: '高', desc: '作文论证结构混乱，缺乏清晰的层次感，论据与论点之间缺少衔接分析。' },
      { id: 2, name: '提炼转述错误',  priority: '高', desc: '材料提炼时容易受次要信息干扰，主旨提炼偏移，归纳段落大意准确率不足。' },
      { id: 4, name: '公文结构错误',  priority: '中', desc: '公文格式背记较熟，但内容组织套路化，缺乏针对题目的灵活调整。' }
    ],
    plan: [
      '第一阶段（1-2周）：优先攻克「作文逻辑不清晰」和「提炼转述错误」',
      '第二阶段（3-4周）：解决「公文结构错误」，同步巩固前两个卡点',
